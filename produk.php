...
if(isset($_POST["addToCart"])){
  ...
  $cek = mysqli_query($conn, "SELECT * FROM tb_cart WHERE id_product = $productID AND id_user = $userID AND status = 'Keranjang'");
...
?>
  ...
  <div class="gallery">
    ...
    if(isset($_GET['category'])){
      ...
      $produk = mysqli_query($conn, 'SELECT * FROM tb_product WHERE product_status != 0');
    }
    foreach ($produk as $p) :
    ?>
    <div class="content">
